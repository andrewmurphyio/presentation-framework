...
- [ ] **Implement ComponentRegistry (src/lib/components/component-registry.ts)** - Register and resolve component renderers by type
- [ ] **Implement ComponentRenderer (src/lib/components/component-renderer.ts)** - Render components to HTML with theme token support
- [ ] **Implement CodeBlock component (src/lib/components/code-block.ts)** - Syntax highlighting, line numbers, line highlighting, copy button
