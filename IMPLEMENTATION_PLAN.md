...
## Phase 4: Advanced Layouts (CURRENT)
...
- [ ] **Define "image-left" layout (src/lib/design-system/layouts/image-left.ts)**
...
- [ ] **Define "image-right" layout (src/lib/design-system/layouts/image-right.ts)**
...
- [ ] **Define "split-40-60" layout (src/lib/design-system/layouts/split-40-60.ts)**
...
- [ ] **Define "split-60-40" layout (src/lib/design-system/layouts/split-60-40.ts)**
...
- [ ] **Define "quote" layout (src/lib/design-system/layouts/quote.ts)**
...
- [ ] **Define "comparison" layout (src/lib/design-system/layouts/comparison.ts)**
