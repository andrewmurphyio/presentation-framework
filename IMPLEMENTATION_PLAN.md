...
- [ ] **Update index.html and styles**
  ...
  - Slide transition CSS (fade or instant for now)
...
- Phase 3: Additional Layouts - Implement section, two-column, code, and content+image layouts
- Phase 4: Components - Build reusable components (code blocks, lists, callouts, images)
- Phase 5: Slide Authoring Format - Define text-based format for writing slides (HTML/markdown variant)
- Phase 6: Build Animations - Implement fragment system and entry/exit animations
- Phase 7: Slide Transitions - Add transition effects between slides
- Phase 8: Media Support - Handle images, videos, and audio with lazy loading
- Phase 9: Presenter View - Dual-monitor support with speaker notes and timer
- Phase 10: Talk Variants - Conditional content system for audience-specific versions
- Phase 11: Talk Metadata - CFP-ready metadata structure with variant support
