...
- [ ] **Define DebugInfo types (src/lib/types/debug.ts)**
...
- [ ] **Implement DebugDataCollector (src/lib/debug/debug-data-collector.ts)**
...
- [ ] **Implement DebugMode class (src/lib/debug/debug-mode.ts)**
...
- [ ] **Implement DebugOverlay component (src/lib/debug/debug-overlay.ts)**
...
- [ ] **Implement LayoutInfoPanel component (src/lib/debug/panels/layout-info-panel.ts)**
...
- Phase 6: Components - Build reusable components (code blocks, lists, callouts, images)
- Phase 7: Slide Authoring Format - Define text-based format for writing slides (HTML/markdown variant)
- Phase 8: Build Animations - Implement fragment system and entry/exit animations
- Phase 9: Slide Transitions - Add transition effects between slides
- Phase 10: Media Support - Handle images, videos, and audio with lazy loading
- Phase 11: Presenter View - Dual-monitor support with speaker notes and timer
- Phase 12: Talk Variants - Conditional content system for audience-specific versions
- Phase 13: Talk Metadata - CFP-ready metadata structure with variant support
