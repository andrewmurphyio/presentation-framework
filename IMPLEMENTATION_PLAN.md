...
- [ ] **Define "content" layout (src/lib/design-system/layouts/content.ts)**
...
- [ ] **Define "two-column" layout (src/lib/design-system/layouts/two-column.ts)**
...
- [ ] **Define "code" layout (src/lib/design-system/layouts/code.ts)**
